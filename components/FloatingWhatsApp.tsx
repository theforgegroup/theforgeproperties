...
export const FloatingWhatsApp: React.FC = () => {
  ...
  return (
    <aside aria-label="WhatsApp quick chat" className="fixed bottom-6 right-6 z-50 flex items-center group">
      <span className="hidden md:inline-flex items-center mr-3 px-3.5 py-1.5 rounded-full bg-[#0F172A] text-white text-xs font-semibold shadow-lg border border-[#774DFF]/30 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
