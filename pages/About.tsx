      ...
      <div className="container mx-auto px-6 py-16 md:py-24">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16 mb-24">
          ...
          <div className="lg:w-1/2">
            <h2 className="text-3xl md:text-4xl font-serif text-forge-navy mb-8">The Forge Standard</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mt-12 border-t pt-8 text-center sm:text-left">
               <div><span className="block text-3xl font-bold text-forge-navy">15+</span><span className="text-xs uppercase tracking-widest text-slate-500">Years</span></div>
               <div><span className="block text-3xl font-bold text-forge-navy">200+</span><span className="text-xs uppercase tracking-widest text-slate-500">Sales</span></div>
               <div><span className="block text-3xl font-bold text-forge-navy">₦50B+</span><span className="text-xs uppercase tracking-widest text-slate-500">Volume</span></div>
            </div>
          </div>
        </div>
