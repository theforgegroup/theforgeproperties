    ...
    <div className="min-h-screen bg-white">
      <div className="relative pt-32 pb-20 bg-forge-navy text-white overflow-hidden">
         ...
         <div className="container mx-auto px-6 text-center relative z-10">
            ...
            <h1 className="text-4xl md:text-7xl font-serif font-bold mb-6">Building Legacy</h1>
      ...
      <div className="container mx-auto px-4 md:px-6 py-16 md:py-24">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16 mb-24">
          <div className="lg:w-1/2 relative">
            ...
            <img src="https://images.unsplash.com/photo-1497366216548-37526070297c?q=80&w=1600" alt="Office" className="w-full h-auto shadow-2xl relative z-10" />
          </div>
          <div className="lg:w-1/2">
            <h2 className="text-2xl md:text-4xl font-serif text-forge-navy mb-6 md:mb-8">The Forge Standard</h2>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-6 md:gap-8 mt-12 border-t pt-8 text-center sm:text-left">
               <div><span className="block text-2xl md:text-3xl font-bold text-forge-navy">15+</span><span className="text-[10px] uppercase tracking-widest text-slate-500">Years</span></div>
               <div><span className="block text-2xl md:text-3xl font-bold text-forge-navy">200+</span><span className="text-[10px] uppercase tracking-widest text-slate-500">Sales</span></div>
               <div className="col-span-2 sm:col-span-1"><span className="block text-2xl md:text-3xl font-bold text-forge-navy">₦50B+</span><span className="text-[10px] uppercase tracking-widest text-slate-500">Volume</span></div>
            </div>
          </div>
        </div>

        <div className="text-center">
          <span className="text-forge-gold text-[10px] uppercase tracking-[0.3em] font-bold mb-3 block">Our People</span>
          <h2 className="text-2xl md:text-4xl font-serif text-forge-navy mb-10 md:mb-16">The Leadership Team</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12 max-w-6xl mx-auto">
            {teamMembers.map((member, i) => (
              <div key={i} className="group text-center sm:text-left">
                <div className="relative w-full aspect-[3/4] mb-6 overflow-hidden bg-slate-100 flex items-center justify-center shadow-md">
                   {member.image ? (
                ...
                <h3 className="text-xl md:text-2xl font-serif text-forge-navy group-hover:text-forge-gold transition-colors">{member.name}</h3>
                <p className="text-slate-500 text-[10px] uppercase tracking-widest font-bold mt-1">{member.role}</p>
              </div>
            ))}
          </div>
        </div>
