    ...
    <div className="min-h-screen bg-white">
      <div className="relative pt-32 pb-20 bg-slate-900 text-white overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
           <span className="text-forge-gold text-xs uppercase tracking-[0.4em] font-bold mb-4 block">The Forge Journal</span>
           <h1 className="text-4xl md:text-6xl font-serif font-bold mb-6">Insights & Perspective</h1>
           <p className="text-slate-400 max-w-2xl mx-auto text-lg leading-relaxed"> News, market trends, and curated lifestyle content. </p>
        </div>
      </div>
