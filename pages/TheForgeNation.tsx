...
export const TheForgeNation: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-[#1A1A1A] pt-20">
      ...
      <section className="bg-[#1A2847] text-white py-20 px-4 sm:px-6 relative overflow-hidden border-b-2 border-[#C9962A]/40">
        ...
        <div className="container mx-auto max-w-5xl relative z-10 text-center">
          ...
          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold text-white font-display mb-6 leading-tight">
            Welcome to <span className="text-[#C9962A]">The Forge Nation</span>
          </h1>
          ...
          <div className="mt-8 inline-flex items-center gap-3 bg-white/10 px-5 py-2.5 rounded-full border border-white/20 backdrop-blur-sm">
            <div className="flex -space-x-2 overflow-hidden">
              <img className="inline-block h-7 w-7 rounded-full ring-2 ring-[#1A2847]" src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=100&auto=format&fit=crop&q=80" alt="member" />
              <img className="inline-block h-7 w-7 rounded-full ring-2 ring-[#1A2847]" src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&auto=format&fit=crop&q=80" alt="member" />
              <img className="inline-block h-7 w-7 rounded-full ring-2 ring-[#1A2847]" src="https://images.unsplash.com/photo-1517841905240-472988babdf9?w=100&auto=format&fit=crop&q=80" alt="member" />
            </div>
            <span className="text-xs font-bold text-white tracking-wide">
              <strong className="text-[#C9962A]">500+ members</strong> and counting across Nigeria & Diaspora
            </span>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 sm:px-6 bg-[#F2F2F0]">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            ...
            <div className="p-8 rounded-[12px] bg-white border border-slate-200 shadow-sm hover:border-[#C9962A] transition-all flex flex-col justify-between">
              <div>
              ...
              <div className="mt-4 pt-3 border-t border-slate-100 text-xs font-bold text-[#C9962A] uppercase tracking-wider">
      ...
      {/* JOIN SECTION — Form with Name, Phone, Email, Location + Button in Gold */}
      <section id="join-form-section" className="py-20 px-4 sm:px-6 bg-white">
        <div className="container mx-auto max-w-2xl">
          <div className="bg-[#1A2847] text-white rounded-[16px] p-8 sm:p-12 border-2 border-[#C9962A] shadow-2xl relative">
            ...
            {isSuccess ? (
              <div className="text-center py-6 space-y-5">
                <div className="w-16 h-16 bg-[#FDF3E3] text-[#C9962A] rounded-full mx-auto flex items-center justify-center border-2 border-[#C9962A]/40 shadow-inner">
                  <CheckCircle2 size={36} />
                </div>
                <div className="space-y-1">
                  <span className="text-xs font-bold uppercase tracking-[2px] text-[#C9962A]">Registration Confirmed</span>
                ...
                <div className="pt-2 flex flex-col items-center gap-3 justify-center">
                  ...
                  <div className="w-full max-w-md bg-white/10 rounded-[8px] p-3 text-left border border-white/20">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-xs text-[#C9962A] hover:underline font-mono break-all inline-block"
                    >
                  ...
                  <button
                    ...
                    className="text-xs text-slate-300 hover:text-white underline mt-2 py-2"
                  >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 text-sm bg-white text-[#1A1A1A] rounded-[8px] focus:outline-none focus:ring-2 focus:ring-[#C9962A] min-h-[44px]"
                  />
                </div>
