...
export const MOCK_LEADS: Lead[] = [
  {
    ...
    // Fixed: propertyId -> property_id
    property_id: '2',
    // Fixed: propertyTitle -> property_title
    property_title: 'Diplomatic Zone Mansion',
    date: '2025-11-30',
    status: 'Qualified',
    type: 'Offer'
  },
  {
    ...
    property_id: '4',
    // Fixed: propertyTitle -> property_title
    property_title: 'Eko Atlantic Ocean View Penthouse',
    date: '2025-11-29',
    status: 'New',
  ...
  },
  {
    ...
    property_id: '10',
    // Fixed: propertyTitle -> property_title
    property_title: 'Guzape Hilltop White House',
    date: '2025-11-26',
    status: 'Contacted',
